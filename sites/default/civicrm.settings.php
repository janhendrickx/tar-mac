...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@localhost/tar_mac_be?new_link=true' );
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://root:root@localhost/civiCRM_tarmac?new_link=true' );
}
...
$civicrm_root = '/Users/Jan/Google Drive/sites/tarmac/site/sites/all/modules/contrib/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Users/Jan/Google Drive/sites/tarmac/site/sites/default/files/civicrm/templates_c/' );
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://tar-mac.test/' );
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '23dcf5383cce04eb62b2ba8953a52efd' );
}
...
// define( 'CIVICRM_MAIL_LOG', '/Users/Jan/Google Drive/sites/tarmac/site/sites/default/files/civicrm/templates_c//mail.log' );
// }
