<?php /* Smarty version 2.6.27, created on 2015-04-30 21:16:26
...
<?php if ($this->_tpl_vars['showLinks']): ?>
    <div class="action-link">
      <?php $this->_tag_stack[] = array('crmButton', array('accesskey' => 'N','p' => $this->_tpl_vars['newMassUrl'],'q' => 'reset=1','icon' => "mail-closed")); $_block_repeat=true;smarty_block_crmButton($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo $this->_tpl_vars['linkTitle']; ?>
